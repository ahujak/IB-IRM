...
class IB_IRM(ERM):
    ...
    def update(self, minibatches, unlabeled=None):
        ...
        var_loss = all_features.var(dim=0).mean()
...
class IB_IRM_F_NC(ERM):
    """Information Bottleneck based IRM on feature with conditionning"""

    def __init__(self, input_shape, num_classes, num_domains, hparams):
        super(IB_IRM_F_NC, self).__init__(input_shape, num_classes, num_domains,
                                  hparams)
        self.optimizer = torch.optim.Adam(
            list(self.featurizer.parameters()) + list(self.classifier.parameters()),
            lr=self.hparams["lr"],
    ...
    def update(self, minibatches, unlabeled=None):
        ...
        nll /= len(minibatches)
        irm_penalty /= len(minibatches)
        ib_penalty = all_features.var(dim=0).mean() / len(minibatches)
...
class IB_IRM_F_C_S(ERM):
    """Information Bottleneck based IRM on feature with conditionning"""

    def __init__(self, input_shape, num_classes, num_domains, hparams):
        super(IB_IRM_F_C_S, self).__init__(input_shape, num_classes, num_domains,
                                  hparams)
        self.optimizer = torch.optim.Adam(
            list(self.featurizer.parameters()) + list(self.classifier.parameters()),
            lr=self.hparams["lr"],
    ...
    def update(self, minibatches, unlabeled=None):
        ...
        # Compile loss
        loss = nll 
        loss += irm_penalty_weight * irm_penalty * self.hparams['irm_switch']
        loss += ib_penalty_weight * ib_penalty
...
class IB_IRM_F_NC_S(ERM):
    """Information Bottleneck based IRM on feature with conditionning"""

    def __init__(self, input_shape, num_classes, num_domains, hparams):
        super(IB_IRM_F_NC_S, self).__init__(input_shape, num_classes, num_domains,
                                  hparams)
        self.optimizer = torch.optim.Adam(
            list(self.featurizer.parameters()) + list(self.classifier.parameters()),
            lr=self.hparams["lr"],
...
class IB_IRM_L_C(ERM):
    """Information Bottleneck based IRM on Logits with conditionning"""

    def __init__(self, input_shape, num_classes, num_domains, hparams):
        super(IB_IRM_L_C, self).__init__(input_shape, num_classes, num_domains,
                                  hparams)
        self.optimizer = torch.optim.Adam(
            list(self.featurizer.parameters()) + list(self.classifier.parameters()),
            lr=self.hparams["lr"],
    ...
    def update(self, minibatches, unlabeled=None):
        ...
        for i, (x, y) in enumerate(minibatches):
            ...
            nll += F.cross_entropy(logits, y)
            irm_penalty += self._irm_penalty(logits, y)
            ib_penalty += logits.var(dim=0).mean()
...
class IB_IRM_L_NC(ERM):
    """Information Bottleneck based IRM on Logits with conditionning"""

    def __init__(self, input_shape, num_classes, num_domains, hparams):
        super(IB_IRM_L_NC, self).__init__(input_shape, num_classes, num_domains,
                                  hparams)
        self.optimizer = torch.optim.Adam(
            list(self.featurizer.parameters()) + list(self.classifier.parameters()),
            lr=self.hparams["lr"],
    ...
    def update(self, minibatches, unlabeled=None):
        ...
        nll /= len(minibatches)
        ib_penalty = all_logits.var(dim=0).mean() / len(minibatches)
...
class IB_ERM_F_NC(ERM):
    """Information Bottleneck based IRM on feature with conditionning"""

    def __init__(self, input_shape, num_classes, num_domains, hparams):
        super(IB_ERM_F_NC, self).__init__(input_shape, num_classes, num_domains,
                                  hparams)
        self.optimizer = torch.optim.Adam(
            list(self.featurizer.parameters()) + list(self.classifier.parameters()),
            lr=self.hparams["lr"],
...
class IB_ERM_L_C(ERM):
    """Information Bottleneck based IRM on Logits with conditionning"""

    def __init__(self, input_shape, num_classes, num_domains, hparams):
        super(IB_ERM_L_C, self).__init__(input_shape, num_classes, num_domains,
                                  hparams)
        self.optimizer = torch.optim.Adam(
            list(self.featurizer.parameters()) + list(self.classifier.parameters()),
            lr=self.hparams["lr"],
...
class IB_ERM_L_NC(ERM):
    """Information Bottleneck based IRM on Logits with conditionning"""

    def __init__(self, input_shape, num_classes, num_domains, hparams):
        super(IB_ERM_L_NC, self).__init__(input_shape, num_classes, num_domains,
                                  hparams)
        self.optimizer = torch.optim.Adam(
            list(self.featurizer.parameters()) + list(self.classifier.parameters()),
            lr=self.hparams["lr"],
