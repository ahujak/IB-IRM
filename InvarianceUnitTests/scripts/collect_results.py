...
def build_table(dirname, models=None, n_envs=None, num_dim=None, latex=False, standard_error=False,
    ...
    if test_peak == 20:
        error_min = "error_test_peak20"
    elif test_peak == 100:
        error_min = "error_test_peak100"
    elif test_peak == 500:
        error_min = "error_test_peak500"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--test_peak", "--tp", type=int, default=0,
                        help="whether to use test_peak 20 / 100 / 500")
    args = parser.parse_args()

    table, table_avg, table_hparams, table_val, table_val_avg, df = build_table(
        args.dirname, args.models, args.n_envs, args.num_dim, args.latex, test_peak=args.test_peak)
